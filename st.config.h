 ...
 */
static char font[] = "DejaVu Sans Mono:size=8:antialias=true:autohint=false";
 ...
 */
static unsigned int defaultfg = 16;
static unsigned int defaultbg = 17;
static unsigned int defaultcs = 18;
